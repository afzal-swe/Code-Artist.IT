                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                          ...
                          <button class="btn btn-info btn-sm" style="float: right" data-toggle="modal" data-target="#modal-default"> + Add Blog</button>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($blogs as $key=>$row)
                                    <tr>
                                        ...
                                        <td>{{$row->title ?? ''}}</td>
                                        <td>{{ Str::of($row->description ?? '')->limit(50) }}</td>
                                        
                                        <td>
                                          @if ($row->status == '1')
                                          
                                          <a href="{{ route('blogs.status',$row->id) }}" class="btn btn-success btn-xs" style="width:100px;"> Active </a>
                                          @else
                                          
                                          <a href="{{ route('blogs.status',$row->id) }}" class="btn btn-primary btn-xs" style="width:100px;"> Deactive </a>
                                          @endif
                                      </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('blogs.delete',$row->id) }}" id="delete" class="btn btn-danger btn-sm delete" title="Delete Data"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
